...
// RunKubeStateMetrics ...
func RunKubeStateMetrics(factories ...customresource.RegistryFactory) {
	...
	storeBuilder.WithGenerateCustomResourceStoresFunc(storeBuilder.DefaultGenerateCustomResourceStoresFunc(), opts.UseAPIServerCache)
